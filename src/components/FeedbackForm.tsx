...
export const FeedbackForm = ({ onSubmit }: FeedbackFormProps) => {
  ...
  // Update your FeedbackForm component's handleSubmit function
const handleSubmit = async () => {
  ...
  try {
    const response = await fetch(`${API_BASE_URL}/feedback`, {
      ...
      body: JSON.stringify({
        ...
        // Add these if you have them in context
  ...
  return (
    <div className="space-y-4">
      <h3 className="text-lg font-semibold">Give us your feedback</h3>
